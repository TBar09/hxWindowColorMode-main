...
extern class WindowBackend {
	...
	private static function setWindowColorMode(isDarkMode:Bool):Bool;
	...
	@:native("nativeWindowColorMode::setWindowCornerType")
	private static function setWindowCornerType(cornerType:Int):Void;
